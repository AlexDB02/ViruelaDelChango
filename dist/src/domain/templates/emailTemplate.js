...
exports.generatemonkeyPoxEmailTemplate = generatemonkeyPoxEmailTemplate;
const envs_plugin_1 = require("../../config/envs.plugin");
function generatemonkeyPoxEmailTemplate(lat, lng, genre, age) {
    const mapboxUrl = (0, exports.generateMapboxStaticImageURL)(lat, lng);
    return `
    <!DOCTYPE html>
    <html lang="es">
    <head>
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>Detalles del caso reciente</h1>
            </div>
            <div class="content">
                ...
                <p><strong>Coordenadas donde se detectó a la persona enferma:</strong></p>
...
const generateMapboxStaticImageURL = (lat, lng) => {
    const accessToken = envs_plugin_1.envs.MAPBOX_ACCESS_TOKEN; // Reemplaza con tu token de acceso de Mapbox
